      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <p className="text-gray-600 mt-2">
            {isSignUp ? 'Criar conta de administrador' : 'Acesse o painel de gestão'}
          </p>
        </CardHeader>
        <CardContent>
          ...
          <Alert className="mt-4">
            <AlertDescription>
              <strong>Info:</strong> Após criar a conta, você terá acesso completo ao painel administrativo.
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
