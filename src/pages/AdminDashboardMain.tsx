...
import HorariosTabComponent from '@/components/dashboard/HorariosTabComponent';
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <h1 className="text-xl font-bold text-blue-600">Sistema Acadêmico</h1>
            </div>
